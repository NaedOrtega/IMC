...
Planck en su modelo de cuantización, consideró a la energía como,

\[
E_{n} = n h \nu \hspacep{1cm} n \in \mathbb{N},
\]

donde un cuanto es $ E_{0} = h\nu $, con esto en mente podemos diseñar una especie de cuanto para la energía potencial del elevador.\\

La energía potencial del elevador es,

\[
U = mgh,
\]

si consideramos a $ m $ como constante y a $ h $ como la minima altura o una altura fija, entonces la energía potencial cuantizada es,

\[
U = n m g h,
\]

esto implica que solo las configuraciones de masa-energía que sean múltiplos del cuanto mínimo, serán validas, por lo que el elevador no puede tener cualquier masa ni cualquier altura.
