...
El modelo de Rutherford predice como es la disperción de partículas alfa, pero no habla de el espectro de emisión de gases, por lo que el modelo no esta diseñado para contemplar esa interacción. 

\item Bhor impuso que el momento angular del electron dabía estar cuantizado. Físicamente, ¿qué significa que una propiedad como el momento angular sólo pueda tomar ciertos valores discretos y no cualquier valor intermedio?\\

Esto significa que el electrón no puede estar rotando alrededor del nucleo en cualquier orbita, o en otras palabras y debido a la dualidad onda-particula, el electrón solo puede describir ondas estacionarias alrededor del nucleo, si el electrón no describiera ondas estacionarias genería interferencia destructiva. 

\item Un átomo puede absorber un fotón y pasar de un estado de menor energía a uno de mayor energía. ¿Puede un átomo absorber un fotón de cualquier energía? En particular, ¿qué esperaría que ocurriera si la energía del fotón fuera ligeramente mayor que la diferecncia de enrgía entre dos niveles permitidos? \\

El fotón no sería absorbido por el electrón, pensandolo como el electrón una onda estacionaria y el fotón una onda, debido a la dualidad onda-particula, podemos decir que el fotón no entra en resonancia con el electrón y por lo tanto no le brinda su energía para saltar a otro nivel.
...
Donde U es el potencial debido a una carga puntual positiva a una distancia r,

$$ E = \frac12 m_e v^2 - \frac1{4\pi\varepsilon_0} \frac{e^2}r $$

Considerando que en el estado inicial $v = 0$ y la distancia al protón es muy grande $r - \infty$, tenemos que $E_0 = 0$.\\

Igualando la energía en $E_0$ con la de una posición albitraria a distancia $r$ se tiene, 

$$ 0 = \frac12 m_e v^2 - \frac1{4\pi\varepsilon_0} \frac{e^2}r $$

$$ v = \frac{e}{\sqrt{2\pi m_e\varepsilon_0}} \frac{1}{\sqrt{r}} $$
